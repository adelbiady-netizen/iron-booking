...
import hostSettingsRouter from './modules/hostSettings/router';
...
import { joinPublicRouter, joinInviteRouter } from './modules/club/joinRouter';
...
app.use('/api/join',                                       joinPublicRouter);
app.use('/api/restaurants/:restaurantId/club',             clubRouter);
app.use('/api/restaurants/:restaurantId/club',             joinInviteRouter);
