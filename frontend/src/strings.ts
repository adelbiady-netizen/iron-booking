...
export const T = {
  ...
  floorBoard: {
    ...
    moveConfirmBody:  (from: string, to: string) => `From table ${from} → ${to}`,
    moveConfirmBtn:   'Move',
    ...
    pickModeHint:             'Select a table then press Confirm',
    pickModeSeatHint:         'Select a table then press Confirm',
    ...
    pickModeSeatFromMapHint:   (name: string) => `Choose any table for ${name}`,
    ...
    swapModeHint:     'Click a table to swap with',
    ...
    swapConfirmBtn:   'Swap',
    toastSwapDone:    'Reservations swapped successfully',
    ctxSeatGuestHere:  'Seat guest here',
    ctxWalkInHere:     'Walk-in at this table',
  ...
  waitlistPanel: {
    ...
    preferredTimePlaceholder: 'Preferred time (optional, e.g. 19:30)',
    sectionPlaceholder: 'Preferred area (optional)',
    addButton:        'Add to waitlist',
    addBusy:          'Adding…',
    addLink:          '+ Add walk-in',
    addToWaitlistButton: 'Add to waitlist',
    emptyTitle:       'No one waiting',
    emptyHint:        'Add walk-in guests waiting at the entrance for an available table.',
    notifyButton:     'Mark as offered',
    notifiedJustNow:  'Marked as offered just now',
    notifiedAgo:      (n: number) => `Marked as offered ${n}m ago`,
    noShow:           'No-show',
    cancelButton:     'Cancel',
    ...
    durationLabel:      'Seating duration',
    durationCustom:     'Custom',
    durationMinShort:   (n: number) => `${n}m`,
    endsAtPreview:      (t: string) => `Expected end: ${t}`,
    // Table-ready message
    tableReadyButton:        'Send message — table is ready',
    ...
    statusNotified:      'Offered',
    statusOffered:       'Offered (future)',
    statusBooked:        'Booked',
    statusExpired:       'Expired',
    statusDeclined:      'Declined',
    typeLive:            'Waiting now',
  ...
  createDrawer: {
    ...
    confirmNoTable:          'Confirm Reservation',
    ...
    labelParty:           'Guests',
    labelTable:           'Table',
    labelGuestNote:       'Guest notes',
    labelHostNote:        'Host notes',
    noTableSelected:      'No table',
    newResPickHint:       'Click a table on the map to select it',
  ...
  guestDrawer: {
    ...
    placeholderName:      'Full name',
    placeholderPhone:     '+1 555 000 0000',
    placeholderOccasion:  'Birthday, anniversary…',
    ...
    toastConfirmationWhatsappFailed: 'SMS sent — WhatsApp unavailable',
    toastConfirmationBothFailed:     'Confirmation failed — check messaging settings',
  ...
  tableQuickPanel: {
    ...
    unseatKeepTable:      'Cancel seating',
    arrivalLate:      'Late',
  ...
  callDrawer: {
    ...
    futureRes:       'Upcoming reservations',
  ...
  hostDashboard: {
    ...
    reorganizeFloor2:    'Reorganize Floor',
    callLogBtn:          'Call Log',
    bulkConfirmBtn:      'Send Confirmations',
    broadcastBtn:        'Message',
    broadcastTitle:      'Message Guests',
    broadcastPlaceholder:'Type your message…',
    broadcastToAll:      'All guests',
    broadcastToSpecific: 'Specific guests',
    broadcastSend:       'Send',
    broadcastSending:    'Sending…',
    broadcastConfirm:    (n: number) => `Send to ${n} guests?`,
    broadcastConfirmYes: 'Yes, send',
    broadcastConfirmNo:  'Cancel',
    broadcastSuccess:    (sent: number) => `Sent to ${sent} guests`,
    broadcastNoPhone:    'No guests have a phone number',
  },
  ...
  callLog: {
    ...
    tabLog:            'Log',
    queueEmpty:        'No callbacks waiting — all caught up.',
    queuePosition:     (n: number) => `#${n}`,
    waitingFor:        (m: number) => m < 1 ? 'just now' : m < 60 ? `${m} min ago` : `${Math.floor(m / 60)}h ${m % 60}m ago`,
    cbPending:         'Awaiting callback',
    cbInProgress:      'In progress',
    cbInProgressBy:    (name: string) => `In progress — ${name}`,
    cbCompleted:       'Completed',
    cbCancelled:       'Cancelled',
    cbStart:           'Start callback',
    cbComplete:        'Done',
    cbCancel:          'Dismiss',
    cbRelease:         'Release',
    cbCall:            'Call',
    cbNotePlaceholder: 'Short note…',
    cbNoteSave:        'Save note',
    cbClosedRecently:  'Recently handled',
    cbHandledBy:       (name: string) => `by ${name}`,
    cbAlreadyClaimed:  (name: string) => `Already being handled by ${name}`,
    cbActionFailed:    'Action failed — refresh and try again',
  },
