...
export const api = {
  ...
  admin: {
    ...
    restaurants: {
      ...
      updateBranding: (id: string, body: { primaryColor?: string | null; accentColor?: string | null; publicThemePreset?: string | null; logoUrl?: string | null; coverImageUrl?: string | null; heroVideoUrl?: string | null; buttonStyle?: string | null; cardStyle?: string | null; backgroundMood?: string | null; backgroundColorHex?: string | null; backgroundGradientHex?: string | null; websiteUrl?: string | null; instagramUrl?: string | null; googleMapsUrl?: string | null; wazeUrl?: string | null }) =>
    ...
    guestHub: {
      get: (restaurantId: string) =>
        request<{
          ...
          branding: { id: string; name: string; tagline: string | null; phone: string | null; address: string | null; logoUrl: string | null; coverImageUrl: string | null; primaryColor: string | null; themePreset: string | null } | null;
          socialLinks: Array<{ id: string; platform: string; handle: string; sortOrder: number }>;
          publishedBranding: { id: string; name: string; tagline: string | null; phone: string | null; address: string | null; logoUrl: string | null; coverImageUrl: string | null; primaryColor: string | null; themePreset: string | null } | null;
      ...
      updateBranding: (restaurantId: string, body: { name: string; tagline: string | null; phone: string | null; address: string | null; logoUrl: string | null; coverImageUrl: string | null; themePreset?: string | null }) =>
        request<{ id: string; name: string; tagline: string | null; phone: string | null; address: string | null; logoUrl: string | null; coverImageUrl: string | null; primaryColor: string | null; themePreset: string | null }>(
      ...
      provision: (restaurantId: string) =>
        request<{
          ...
          publicStatus: 'DRAFT' | 'PUBLISHED' | 'INACTIVE';
          lastPublishedAt: string | null; draftUpdatedAt: string | null;
          branding: { id: string; name: string; tagline: string | null; phone: string | null; address: string | null; logoUrl: string | null; coverImageUrl: string | null; primaryColor: string | null } | null;
          socialLinks: Array<{ id: string; platform: string; handle: string; sortOrder: number }>;
          publishedBranding: { id: string; name: string; tagline: string | null; phone: string | null; address: string | null; logoUrl: string | null; coverImageUrl: string | null; primaryColor: string | null } | null;
          publishedSocialLinks: Array<{ id: string; platform: string; handle: string; sortOrder: number }>;
          qrTokens: Array<{ id: string; token: string; label: string | null; isActive: boolean; metadata: Record<string, unknown> | null }>;
