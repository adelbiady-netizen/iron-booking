...
export const api = {
  ...
  admin: {
    ...
    restaurants: {
      ...
      updateBranding: (id: string, body: { primaryColor?: string | null; accentColor?: string | null; publicThemePreset?: string | null; logoUrl?: string | null; coverImageUrl?: string | null; heroVideoUrl?: string | null; buttonStyle?: string | null; cardStyle?: string | null; backgroundMood?: string | null }) =>
        request<{ id: string; primaryColor: string | null; accentColor: string | null; publicThemePreset: string | null; logoUrl: string | null; coverImageUrl: string | null; heroVideoUrl: string | null; buttonStyle: string | null; cardStyle: string | null; backgroundMood: string | null }>(`/admin/restaurants/${id}/branding`, { method: 'PATCH', body: JSON.stringify(body) }),
