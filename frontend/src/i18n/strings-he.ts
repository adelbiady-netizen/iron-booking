...
export const THe = {
  ...
  floorBoard: {
    ...
    moveConfirmBody:  (from: string, to: string) => `משולחן ${from} ← ${to}`,
    moveConfirmBtn:   'העבר',
    ...
    pickModeHint:             'בחרו שולחן ואשרו בכפתור אישור',
    pickModeSeatHint:         'בחרו שולחן ואשרו בכפתור אישור',
    ...
    pickModeMoveHint:         (name: string) => `בחרו שולחן חדש עבור ${name}`,
    ...
    pickModeSeatFromMapHint:   (name: string) => `בחר שולחן עבור ${name}`,
    ...
    soon:             'בקרוב',
    ctxSwap:          'החלף הזמנות',
    swapModeHint:     'לחץ על שולחן להחלפה',
    swapModeCancel:   'ביטול החלפה',
    swapConfirmTitle: (a: string, b: string) => `להחליף בין ${a} ל-${b}?`,
    swapConfirmBody:  (tableA: string, tableB: string) => `${tableA} ↔ ${tableB}`,
    swapConfirmBtn:   'החלף',
    toastSwapDone:    'ההזמנות הוחלפו בהצלחה',
    ctxSeatGuestHere:  'שבץ אורח כאן',
    ctxWalkInHere:     'אורח מזדמן לשולחן זה',
    ctxGuestArrived:   'הגיע',
    ctxGuestConfirmed: 'מאושר',
    ctxGuestWaitlist:  'מזדמנים',
  ...
  tableCard: {
    ...
    inNMin:          (n: number) => `בעוד ${n} דק׳`,
    waitlistWaiting: (n: number) => `מזדמנים · ${n} דק׳ ממתין`,
    locked:          'נעול',
  },
  ...
  waitlistPanel: {
    ...
    preferredTimePlaceholder: 'שעה מועדפת (אופציונלי, לדוגמה 19:30)',
    sectionPlaceholder: 'אזור מועדף (אופציונלי)',
    addButton:        'הוסף לרשימה',
    addBusy:          'מוסיף…',
    addLink:          '+ הוסף מזדמן',
    addToWaitlistButton: 'הוסף למזדמנים',
    emptyTitle:       'אין מזדמנים כרגע',
    emptyHint:        'הוסף אורחים שמחכים בכניסה לשולחן פנוי.',
    notifyButton:     'סמן כהוצע',
    notifiedJustNow:  'סומן כהוצע זה עתה',
    notifiedAgo:      (n: number) => `סומן כהוצע לפני ${n} דק׳`,
    noShow:           'לא הגיע',
    cancelButton:     'ביטול',
    footerEmpty:      'אין מזדמנים',
    footerCount:      (n: number) => `${n} מזדמנים`,
    ...
    // Seating duration (host-chosen)
    durationLabel:      'זמן ישיבה',
    durationCustom:     'אחר',
    durationMinShort:   (n: number) => `${n} דק׳`,
    endsAtPreview:      (t: string) => `סיום משוער: ${t}`,
    // Table-ready message
    tableReadyButton:        'שליחת הודעה — השולחן מוכן',
    ...
    labelNotes:          'הערות',
    labelAddedAt:        'נוסף',
    labelPreferredTime:  'זמן מועדף',
    notesPlaceholder:    'הערות…',
    saveButton:          'שמור',
    statusWaiting:       'ממתין',
    statusNotified:      'הוצע',
    statusOffered:       'הוצע (עתידי)',
    statusBooked:        'אושר',
    statusExpired:       'פג תוקף',
    statusDeclined:      'סירב',
    typeLive:            'ממתין עכשיו',
    typeFuture:          'תור עתידי',
    sourceOnline:        'אונליין',
    sourcePhone:         'טלפון',
    sourceWalkIn:        'אורח מזדמן',
    drawerSaveError:     'שגיאה בשמירה',
  },

  // ── CreateDrawer ───────────────────────────────────────────────────────────
  createDrawer: {
    titleReservation:     'הזמנה חדשה',
    titleWalkIn:          'אורח מזדמן',
    tabReservation:       'הזמנה',
    tabWalkIn:            'אורח מזדמן',
    ...
    confirmWithTable:        (name: string) => `אישור הזמנה – שולחן ${name}`,
    confirmWithTables:       (names: string) => `אישור הזמנה – שולחנות ${names}`,
    confirmNoTable:          'אישור הזמנה',
    ...
    labelParty:           'סועדים',
    labelTable:           'שולחן',
    labelGuestNote:       'הערות אורח',
    labelHostNote:        'הערות מארח',
    noTableSelected:      'ללא שולחן',
    newResPickHint:       'לחצו על שולחן במפה לבחירה',
  ...
  guestDrawer: {
    ...
    placeholderName:      'שם מלא',
    placeholderPhone:     '+972 50 000 0000',
    placeholderOccasion:  'יום הולדת, יום נישואין…',
    ...
    toastConfirmedSmsFailed:  'ההזמנה אושרה — לא ניתן היה לשלוח SMS',
    ...
    occupiedModalTitle:   'השולחן כרגע מסומן כתפוס',
    occupiedModalBody:    'השולחן עדיין משויך לאורח קודם. האם לסגור את הישיבה הנוכחית ולהושיב את האורח החדש?',
    ...
    toastConfirmationWhatsappFailed: 'SMS נשלח — WhatsApp לא זמין',
    toastConfirmationBothFailed:     'שליחת האישור נכשלה — בדוק הגדרות הודעות',
    ...
    sourceLabels:         { Phone: 'טלפוני', Internal: 'פנימי', 'Walk-in': 'אורח מזדמן', Online: 'אונליין', System: 'מערכת' } as Record<string, string>,
    // Smart suggestion
  ...
  layoutEditor: {
    ...
    sectionRenameTitle: 'שנה שם אזור',
    sectionColorTitle:  'שנה צבע',
    sectionDeleteTitle: 'מחק אזור',
    confirmDeleteSection: (name: string) => `למחוק את האזור "${name}"? לא ניתן לבטל.`,
    sectionHasTables:   'האזור עדיין מכיל שולחנות. יש להעביר או למחוק את השולחנות תחילה.',
    sectionCannotDeleteLast: 'זהו האזור היחיד — לא ניתן למחוק אותו.',
    addTable:           '+ הוסף שולחן',
    tagNew:             'חדש',
    tagOff:             'כבוי',
    ...
    errorSectionDelete: 'מחיקת האזור נכשלה',
    errorSectionRename: 'שינוי שם האזור נכשל',
  ...
  // ── חלונית תקשורת קומפקטית (שיחות) ───────────────────────────────────────────
  callOverlay: {
    title:              'שיחות',
    requiresAttention:  'דורש טיפול',
    viewFullHistory:    'צפייה ביומן השיחות המלא',
    retry:              'נסו שוב',
    reconnecting:       'מתחבר מחדש…',
    noRecent:           'אין טיפולים אחרונים',
    close:              'סגור',
    clearAll:           'סמן הכל כטופל',
    clearAllConfirm:    (n: number) => `לסמן את כל ${n} פריטי החזרה כטופלו?`,
    confirm:            'אישור',
    cancel:             'ביטול',
    undoDone:           'טופל',
    undo:               'בטל',
    undoConflict:       'הפריט השתנה במכשיר אחר ולא ניתן לשחזור',
  },
  ...
  hostDashboard: {
    ...
    reorganizeFloor2:    'סידור מחדש',
    callLogBtn:          'יומן שיחות',
    bulkConfirmBtn:      'שליחת אישורים',
    broadcastBtn:        'הודעה',
    broadcastTitle:      'הודעה ללקוחות',
    broadcastPlaceholder:'כתוב כאן את ההודעה…',
    broadcastToAll:      'כל האורחים',
    broadcastToSpecific: 'לקוחות ספציפיים',
    broadcastSend:       'שלח',
    broadcastSending:    'שולח…',
    broadcastConfirm:    (n: number) => `לשלוח ל-${n} אורחים?`,
    broadcastConfirmYes: 'כן, שלח',
    broadcastConfirmNo:  'ביטול',
    broadcastSuccess:    (sent: number) => `נשלח ל-${sent} אורחים`,
    broadcastNoPhone:    'לאף אורח אין מספר טלפון',
  },
  ...
  callLog: {
    ...
    all:           'הכל',
    // Callback queue
    tabCallbacks:      'חזרה ללקוחות',
    tabLog:            'יומן',
    queueEmpty:        'אין שיחות שממתינות לחזרה — הכל טופל.',
    queuePosition:     (n: number) => `#${n}`,
    waitingFor:        (m: number) => m < 1 ? 'ממש עכשיו' : m < 60 ? `לפני ${m} דק׳` : `לפני ${Math.floor(m / 60)} ש׳ ${m % 60} דק׳`,
    cbPending:         'ממתין לחזרה',
    cbInProgress:      'בטיפול',
    cbInProgressBy:    (name: string) => `בטיפול — ${name}`,
    cbCompleted:       'טופל',
    cbCancelled:       'בוטל',
    cbStart:           'התחל חזרה',
    cbComplete:        'טופל',
    ...
    cbRelease:         'שחרר',
    cbCall:            'חיוג',
    cbNotePlaceholder: 'הערה קצרה…',
    cbNoteSave:        'שמור הערה',
    cbClosedRecently:  'טופלו לאחרונה',
    cbHandledBy:       (name: string) => `ע״י ${name}`,
    cbAlreadyClaimed:  (name: string) => `כבר בטיפול של ${name}`,
    cbActionFailed:    'הפעולה נכשלה — רעננו ונסו שוב',
  },
